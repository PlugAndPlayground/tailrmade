...
const EnumName = 'Enum';
const EnumButtonsName = 'EnumButtons';
const FileName = 'File';
const FunctionName = 'Function';
const ImageName = 'Image';
const JSONTypeName = 'JSONType';
const JSONArrayTypeName = 'JSONArrayType';
...
export class TestDataTypes extends PPNode {
  ...
  getPreferredNodesPerSocket(socket: Socket): string[] {
    switch (socket.name) {
      case BooleanName:
        return ['break', 'constant_string'];
      case ArrayOutName:
        return ['constant_string', 'break'];
    }
    return [];
  }
  ...
  protected getDefaultIO(): Socket[] {
    return [
      ...
      new Socket(
        SOCKET_TYPE.IN,
        EnumButtonsName,
        new EnumType(TESTDATA.ENUM, undefined, true),
        '',
      ),
